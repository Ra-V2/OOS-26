...
class getForm_TypeExtension_Form_ValidatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Form\Extension\Validator\Type\FormTypeValidatorExtension(($container->privates['validator'] ?? $container->load('getValidatorService')), false, $a, ($container->services['translator'] ?? $container->load('getTranslatorService')));

        if (isset($container->privates['form.type_extension.form.validator'])) {
            return $container->privates['form.type_extension.form.validator'];
        }

        return $container->privates['form.type_extension.form.validator'] = $instance;
    }
}
