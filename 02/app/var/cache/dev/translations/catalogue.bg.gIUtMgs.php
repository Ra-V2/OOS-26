...
$catalogue = new MessageCatalogue('bg', array (
  ...
  array (
    ...
    'action.toggle_dropdown' => 'Превключване на падащото меню',
    ...
    'action_confirmation_modal.title' => 'Сигурни ли сте, че искате да %action_name%?',
    'action_confirmation_modal.action' => 'Потвърди',
    'filter.title' => 'Филтри',
    ...
    'filter.label.contains_all' => 'съдържа всички',
    ...
    'exception.general' => 'Възникна грешка при обработката на заявката ви.',
    'exception.general_403' => 'Нямате разрешение за извършване на това действие.',
    'exception.general_404' => 'Заявената страница не е намерена.',
    'exception.general_500' => 'Възникна вътрешна грешка при обработката на заявката ви.',
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'action_confirmation_modal.title' => 'Are you sure you want to %action_name%?',
    'action_confirmation_modal.action' => 'Confirm',
