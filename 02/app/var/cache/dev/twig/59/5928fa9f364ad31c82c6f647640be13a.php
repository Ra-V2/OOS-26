...
class __TwigTemplate_2ad624cdbf85810909d3741cf4f1d786 extends Template
{
...
{% block main %}
    <div class=\"error-message\">
        <h1>{{ component('ea:Icon', { name: 'internal:circle-exclamation' }) }} <span>{{ block('page_title') }}</span></h1>
        {{ exception.publicMessage|trans(exception.translationParameters, 'EasyAdminBundle') }}
    </div>
{% endblock %}
", "@EasyAdmin/exception.html.twig", "/home/student/projobj/app/vendor/easycorp/easyadmin-bundle/templates/exception.html.twig");
    }
}
