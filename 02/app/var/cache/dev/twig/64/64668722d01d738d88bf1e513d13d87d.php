...
class __TwigTemplate_9774a27f4e4f4b263ea832ec642cb5d2 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        ";
            // line 7
            yield (((($tmp = (isset($context["render_as_html"]) || array_key_exists("render_as_html", $context) ? $context["render_as_html"] : (function () { throw new RuntimeError('Variable "render_as_html" does not exist.', 7, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 7, $this->source); })()), "formattedValue", [], "any", false, false, false, 7)) : (Twig\Extension\CoreExtension::nl2br(CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 7, $this->source); })()), "formattedValue", [], "any", false, false, false, 7))));
            yield "
    </span>
";
        } else {
        ...
        ";
            // line 11
            yield CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 11, $this->source); })()), "formattedValue", [], "any", false, false, false, 11);
            yield "
    </span>
";
        }
...
{% if ea().crud.currentAction == 'detail' %}
    <span title=\"{{ field.value }}\">
        {{ render_as_html ? field.formattedValue|raw : field.formattedValue|raw|nl2br }}
    </span>
{% else %}
    <span title=\"{{ field.value }}\">
...
{% endif %}
", "@EasyAdmin/crud/field/textarea.html.twig", "/home/student/projobj/app/vendor/easycorp/easyadmin-bundle/templates/crud/field/textarea.html.twig");
    }
}
