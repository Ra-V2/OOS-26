...
class __TwigTemplate_59486202b405e4ec0231d2ebcdca973c extends Template
{
    ...
    {% component 'ea:ActionMenu:ActionList' with { class: 'dropdown-menu' } %}
        {% block content %}{% for item in group.items %}
            ...
            {% else %}
                ...
                {{ component('ea:ActionMenu:ActionList:Item', { label: (item.label|trans), icon: (item.icon), class: (item.cssClass)~' dropdown-item-variant-'~(item.variant.value), htmlAttributes: (item.htmlAttributes|ea_html_attrs), renderAsForm: (item.isRenderedAsForm), url: (item.linkUrl), renderLabelRaw: 'true', showBlankIcons: (group.hasAnyActionWithIcon) }) }}
            {% endif %}
        {% endfor %}
    {% endblock %}{% endcomponent %}
</div>
", "@EasyAdmin/crud/action_group.html.twig", "/home/student/projobj/app/vendor/easycorp/easyadmin-bundle/templates/crud/action_group.html.twig");
    }
}


/* @EasyAdmin/crud/action_group.html.twig */
class __TwigTemplate_59486202b405e4ec0231d2ebcdca973c___7386223461 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
...
/* @EasyAdmin/crud/action_group.html.twig */
class __TwigTemplate_59486202b405e4ec0231d2ebcdca973c___29748985831 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
...
/* @EasyAdmin/crud/action_group.html.twig */
class __TwigTemplate_59486202b405e4ec0231d2ebcdca973c___30574258061 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
...
/* @EasyAdmin/crud/action_group.html.twig */
class __TwigTemplate_59486202b405e4ec0231d2ebcdca973c___25918203721 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
