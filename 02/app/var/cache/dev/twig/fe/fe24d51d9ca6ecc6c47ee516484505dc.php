...
class __TwigTemplate_e18b16973423b50ca75920f97074440e extends Template
{
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            yield "</td>
                <td>";
            // line 21
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "name", [], "any", false, false, false, 21), "html", null, true);
            yield "</td>
                <td>";
            // line 22
...
{% endblock %}
", "user/index.html.twig", "/home/student/projobj/app/templates/user/index.html.twig");
    }
}
